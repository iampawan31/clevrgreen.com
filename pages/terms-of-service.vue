  ...
  <div class="pt-10 mb-36">
    <div class="container mx-auto px-80">
      ...
      <div class="mt-6">
        ...
        <div>
          This website is operated by Clevrgreen. Throughout the site, the terms
          “we”, “us” and “our” refer to Clevrgreen. Clevrgreen offers this
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 1 - ONLINE STORE TERMS</div>
        <p>
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 2 - GENERAL CONDITIONS</div>
      ...
      <div class="mt-10">
        ...
        <p>
          You agree that it is your responsibility to monitor changes to our
          site.
        </p>
      </div>
      <div class="mt-10">
      ...
      <div class="mt-10">
        ...
        <p class="mt-6">For more detail, please review our Returns Policy.</p>
      </div>
      <div class="mt-10">
        <div class="font-semibold">SECTION 7 - OPTIONAL TOOLS</div>
        <p>
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 8 - THIRD-PARTY LINKS</div>
        <p>
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 10 - PERSONAL INFORMATION</div>
        <p>
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 12 - PROHIBITED USES</div>
        <p>
      ...
      <div class="mt-10">
        ...
        <p>
          In no case shall Clevrgreen, our directors, officers, employees,
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 14 - INDEMNIFICATION</div>
        <p>
          You agree to indemnify, defend and hold harmless Clevrgreen and our
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 15 - SEVERABILITY</div>
        <p>
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 16 - TERMINATION</div>
        <p>
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 17 - ENTIRE AGREEMENT</div>
        <p>
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 18 - GOVERNING LAW</div>
        <p>
      ...
      <div class="mt-10">
        <div class="font-semibold">SECTION 20 - CONTACT INFORMATION</div>
        <p>
          Questions about the Terms of Service should be sent to us at
          <a class="text-primary" href="mailto:support@clevrgreen.com"
            >support@clevrgreen.com</a
          >.
        </p>
      </div>
      <div class="mt-10">
        <div class="font-semibold">SECTION 21 - GROWER'S GUARANTEE</div>
        <p>
          Our grower's guarantee requires customers to meet the following
          criteria in order to qualify for additional free support and possible
          gifting of additional nutrient packages.
        </p>
        <ul class="list-decimal list-inside mt-4">
          <li>
            User has responded to all automated warnings for system failure and
            has responded in a timely manner that did not cause catastrophic
            failure (24 hours)
          </li>
          <li>
            User has submitted a minimum of 1 help request to Clevrgreen to
            facilitate support with their kit/plants
          </li>
          <li>
            User can prove they purchased their plants/clones legally from a
            licensed nursery in their respective state.
          </li>
        </ul>
      </div>
      <div class="mt-10">
        <p>
          Clevrgreen reserves the right to void any guarantee if any neglect or
          failure to use the equipment within the proper settings or recommended
          maintenance occurs.
        </p>
      </div>
      <div class="mt-10">
        <p>
          Clevrgreen is not responsible or does not condone or support the
          growing of any plants that are outside of the legal use or limits
          within a users respective state.
        </p>
      </div>
    </div>
  </div>
